...
output_file = "/trace/group/acmegroup/atimmins/testing/BEEF_Research/PbI2_mp22893/V_Pb/experiments/ex47_332/supercells/PRISTINE_0/0/unitcell/espresso.pwo"
...
correction_params = {
	...
	'auto_select_bands': False,
        ...
        'band_by_charge' : { #specify if auto_select_bands is true,
            -2:425, #425 only one that seems to work
            -1:423, #423 and 424 works. 423 is better fit
            0:424,
        },
	'sigma_by_charge': {
        },
	'epsilon':17,
	'grid_size':[160,160,180],
    },
}
