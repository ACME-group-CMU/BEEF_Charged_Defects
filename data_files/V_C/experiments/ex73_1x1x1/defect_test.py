...
output_file = "/trace/group/acmegroup/atimmins/testing/BEEF_Research/V_C/experiments/ex73_1x1x1/supercells/PRISTINE_0/0/unitcell/espresso.pwo"
...
tracker.calculatePristineEnergy(input_data,pseudopotentials,kpts,comp_params,force_recalc=force_recalc,correction_params=correction_params)


#Add defects
defect = {'C': -1}
relevant_species = {}
charge_list = [0,-1,1,2,-2]
